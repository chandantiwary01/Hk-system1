...
const Navbar = ({ isMenuOpen, toggleMenu }) => {
  return (
    ...
    >
      {/* 1. Top Spacing  */}
      <div className="h-14 sm:h-16 md:h-[99px] w-full bg-black"></div>
      ...
      <div className="max-w-[1743px] mx-auto px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 flex justify-between items-center relative">
        ...
        >
          ...
          <motion.button
            ...
            className="hidden sm:block border px-4 sm:px-6 md:px-8 py-2 md:py-2.5 rounded-full text-[9px] sm:text-[10px] md:text-[12px] uppercase font-medium hover:bg-white hover:text-black transition-all duration-300 shadow-md"
          >
            Book a Tour
          </motion.button>
          ...
          <motion.button
            onClick={toggleMenu}
            className="p-2 sm:p-2.5 md:p-3 border rounded-full hover:bg-white/10 transition-colors flex items-center justify-center z-[60] shrink-0 relative w-10 h-10"
            style={{ borderColor: "#F3F3F3" }}
          >
